...
DEFAULT_DIRECTORY = r"C:\Users\kob\Desktop\Dummy_Data"
DEFAULT_NAMING_CONVENTION = "Butane_3um_*ang_TDC2228A.dat"
...
def calculate_statistics(data):
    cross_section = sum(data)
    standard_error = statistics.stdev(data) / (NUMBER_OF_TIME_BINS ** 0.5)
